...
const sunsetText = `#FF6F61, #FF9A8B, #FFB77A, #FFCE7A, #FFD891, #FFE7B2, #FFF5D1, #FFBFA5, #FF9C9F, #FF7F67, #FF6C3F, #FF5722, #FF4C00, #FF3D00, #FF2C00`;
export const STYLES = ["retro", "sunset"]
